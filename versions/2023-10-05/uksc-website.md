...
```bicep
module exampleInstance 'ts/IacModules:\uksc-website:2023-10-05' = {
...
| Microsoft.ManagedIdentity/userAssignedIdentities@2018-11-30 | `existingManagedIdentitywebsite` | `resourceGroup(persistentResourceGroup)` |
